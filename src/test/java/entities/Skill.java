...
public class Skill {
    ...
    public Skill(String name, int baseValue, int professionBase) {
        this.name = name;
        this.baseValue = baseValue;
        this.professionBase = professionBase;
    }

    public Skill(String name, List<String> randomInputs, int baseValue, int professionBase, Skill exclusive, String input) {
        this.name = name;
    ...
    public String getSkillDisplayText() {
        String out = name.replace("-", " ") + " " + professionBase + "%";
        if(input == null) {
            return out;
        }
